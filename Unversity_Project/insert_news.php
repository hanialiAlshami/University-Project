...
<body>
    ...
    <body>
        ...
        if (isset($_POST['add'])) {
            ...
            $sql = "INSERT INTO News (Name,details,date_pub, image) VALUES ('$name', '$mas', '$tim11', '$image_name')";
        ...
        <div class="form-container">
            <form action="insert_news.php" method="post" enctype="multipart/form-data" autocomplete="off">
